...
// function getStyle(zoomValue = 100, text, bgColor, outlined) {
//   const isFirefox = navigator.userAgent.toLowerCase().indexOf("firefox") > -1;
//   let baseStyle = {
//     width: `${text.width * (zoomValue / 100)}px`,
//     height: `${text.height * (zoomValue / 100)}px`,
...
//     outline: "none",
//     resize: "none",
//     fontSize: `${text.fontSize * (zoomValue / 100)}px`,
//     fontFamily: text.fontFamily,
//     lineHeight: "1",
//     overflow: "hidden",
//     color: outlined ? bgColor : text.color,
//     fontWeight: text.bold !== false ? 700 : 600,
//     outlined: "none",
//     // border: "0px",
//     overflow: "hidden",
...
//   if (outlined) {
//     baseStyle["-webkit-text-stroke"] = "1px black";
//   }
