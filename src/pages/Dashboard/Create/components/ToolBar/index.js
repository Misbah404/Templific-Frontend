...
const ToolBar = (props) => {
  const {selectedStage, layout, selectElement, setSelectElement, zoomValue} =
    props;
  ...
  const handleLockElement = () => {
    ...
    // if (selectElement && selectElement.type === "rect")
    //   selectedStage?.canvas?.current?.handleRectUpdateLockState(
    //     selectElement.id
    //   );

    // if (selectElement && selectElement.type === "line")
    //   selectedStage?.canvas?.current?.handleLineUpdateLockState(
    //     selectElement.id
    //   );

    // if (selectElement && selectElement.type === "ellipse")
    //   selectedStage?.canvas?.current?.handleEllipseUpdateLockState(
    //     selectElement.id
    //   );

    // if (selectElement && selectElement.type === "arrow")
    //   selectedStage?.canvas?.current?.handleArrowUpdateLockState(
    //     selectElement.id
    //   );

    // if (selectElement && selectElement.type === "polygon")
    //   selectedStage?.canvas?.current?.handlePolygonUpdateLockState(
    //     selectElement.id
    //   );

    // if (selectElement && selectElement.type === "image")
    //   selectedStage?.canvas?.current?.handleImageUpdateLockState(
    //     selectElement.id
    //   );

    // if (selectElement && selectElement.type === "star")
    //   selectedStage?.canvas?.current?.handleStarUpdateLockState(
    //     selectElement.id
    //   );
